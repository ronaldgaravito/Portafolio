        ...
        <div className="hero__inner">
          ...
          <div className="hero__content">
            ...
            <p className="hero__desc">
              {t.heroDesc}{" "}
              <span className="hero__location">{t.heroLocation}</span>
            </p>
            ...
            <div className="hero__actions">
              ...
              <a
                href="/cv ronald.pdf"
                download="CV_Ronald_Garavito.pdf"
                className="btn-outline"
                id="hero-download-cv"
              >
                <svg
          ...
          <div className="hero__image-wrapper">
            ...
            {/* Floating badges */}
            <div className="hero__float-badge hero__float-badge--java">
              <span>☕</span> Java
            </div>
            <div className="hero__float-badge hero__float-badge--react">
              <span>⚛️</span> React
            </div>
            <div className="hero__float-badge hero__float-badge--spring">
              <span>🍃</span> Spring
            </div>
          </div>
        </div>
