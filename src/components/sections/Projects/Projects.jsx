      ...
      <div className="container">
        ...
        <div className="projects__grid">
          {projects.map((project, i) => (
            <div
              key={project.id}
              className={`project-card glass-card ${project.featured ? 'project-card--featured' : ''} ${project.id === 3 ? 'project-card--clickable' : ''}`}
              style={{ animationDelay: `${i * 0.15}s`, '--card-color': project.color }}
              onClick={() => { if (project.id === 3) setSelectedProject(project); }}
            >
              {/* Card Header */}
        ...
        {/* Modal for DB Designer */}
        {selectedProject && selectedProject.id === 3 && (
