...
const projects = [
  ...
  {
    id: 3,
    title: 'Consumo de API (Grupal)',
    description: 'Proyecto grupal enfocado en el consumo de una API y la implementación de mejoras a la aplicación.',
    tags: ['API', 'Frontend', 'Desarrollo Colaborativo'],
    emoji: '🌐',
    color: '#eab308',
